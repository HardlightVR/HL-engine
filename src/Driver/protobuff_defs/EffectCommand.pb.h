...
enum EffectCommand_Command {
  ...
  EffectCommand_Command_ENABLE_RTP = 5,
  EffectCommand_Command_ENABLE_INTRIG = 6,
...
const EffectCommand_Command EffectCommand_Command_Command_MAX = EffectCommand_Command_ENABLE_INTRIG;
...
class EffectCommand : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:NullSpaceIPC.EffectCommand) */ {
 public:
  ...
  static const Command ENABLE_RTP =
    EffectCommand_Command_ENABLE_RTP;
  static const Command ENABLE_INTRIG =
    EffectCommand_Command_ENABLE_INTRIG;
...
inline ::google::protobuf::uint32 EffectCommand::effect() const {
  // @@protoc_insertion_point(field_get:NullSpaceIPC.EffectCommand.effect)
  return effect_;
}
inline void EffectCommand::set_effect(::google::protobuf::uint32 value) {
