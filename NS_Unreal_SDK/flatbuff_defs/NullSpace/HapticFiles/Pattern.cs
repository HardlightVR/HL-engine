...
public struct Pattern : IFlatbufferObject
{
  ...
  public NullSpace.HapticFiles.HapticFrame? Items(int j) { int o = __p.__offset(4); return o != 0 ? (NullSpace.HapticFiles.HapticFrame?)(new NullSpace.HapticFiles.HapticFrame()).__assign(__p.__indirect(__p.__vector(o) + j * 4), __p.bb) : null; }
  ...
  public static VectorOffset CreateItemsVector(FlatBufferBuilder builder, Offset<NullSpace.HapticFiles.HapticFrame>[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddOffset(data[i].Value); return builder.EndVector(); }
